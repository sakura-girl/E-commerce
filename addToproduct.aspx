<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="addToproduct.aspx.cs" Inherits="addToproduct" %>
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   <asp:DropDownList ID="ddlSubCategory" CssClass ="form-control" runat="server" 
                       AutoPostBack="True" 
                       onselectedindexchanged="ddlSubCategory_SelectedIndexChanged1"></asp:DropDownList>
               </div>
           </div>
           ...
           <div class ="form-group">
                    ...
                    <div class ="col-md-6 ">
                        ...
                        <asp:Button ID="btnAdd" CssClass ="btn btn-success " runat="server" 
                            Text="ADD Product" onclick="btnAdd_Click1" />
