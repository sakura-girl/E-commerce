...
public partial class forgotpassword : System.Web.UI.Page
{
    ...
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["onlinedb"].ConnectionString))
        {
            con.Open();
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi ," + Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> http://localhost:15221/ecommerce/RecoverPassword.aspx?id=" + myGUID;


                MailMessage PassRecMail = new MailMessage("gmail add", ToEmailAddress);
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("gmail add", "gmail password");
