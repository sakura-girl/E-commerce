...
<br />
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item <%# GetActiveImgClass(Container.ItemIndex) %>">
      <img src="images/productImage/<%# Eval("PID") %>/<%# Eval("Name") %><%# Eval("Extention") %>" alt="<%# Eval("Name") %>">
            ...
            <div >
                ...
                <div>
                    <asp:radiobuttonlist ID="rblSize" runat="server" RepeatDirection="Horizontal" >
                        <asp:ListItem Value="50 ml" Text="50 ml"></asp:ListItem>
                        <asp:ListItem Value="100 ml" Text="100  ml"></asp:ListItem>
                        <asp:ListItem Value="150 ml" Text="150 ml"></asp:ListItem>
                        <asp:ListItem Value="200 ml" Text="200 ml"></asp:ListItem>
                    </asp:radiobuttonlist>
                </div>
            </div>
            <div class="divDet1">
